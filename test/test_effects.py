...
from imageedit import io, effects
...
def test_addDropShadowSimple_topLeft():
	...
	left
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowSimple_topLeft.png", effects.addDropShadowSimple(IMAGE, [-50, -50]))
...
def test_addDropShadowSimple_topRight():
	...
	right
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowSimple_topRight.png", effects.addDropShadowSimple(IMAGE, [50, -50]))
...
def test_addDropShadowSimple_bottomLeft():
	...
	left
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowSimple_bottomLeft.png", effects.addDropShadowSimple(IMAGE, [-50, 50]))
...
def test_addDropShadowSimple_bottomRight():
	...
	right
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowSimple_bottomRight.png", effects.addDropShadowSimple(IMAGE, [50, 50]))
...
def test_addDropShadowComplex_Iterateffectsns0():
	...
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowComplex_Iterateffectsns0.png", effects.addDropShadowComplex(IMAGE, 0, 50, [50, 50], "#ff0000", "#000000"))
...
def test_addDropShadowComplex_Iterateffectsns100():
	...
	bottom right on a red background
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowComplex_Iterateffectsns100.png", effects.addDropShadowComplex(IMAGE, 100, 50, [50, 50], "#ff0000", "#000000"))
...
def test_addDropShadowComplex_Border0():
	...
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowComplex_Border0.png", effects.addDropShadowComplex(IMAGE, 5, 0, [50, 50], "#ff0000", "#000000"))
...
def test_addDropShadowComplex_Border100():
	...
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowComplex_Border100.png", effects.addDropShadowComplex(IMAGE, 5, 100, [50, 50], "#ff0000", "#000000"))
...
def test_addDropShadowComplex_BGBlue():
	...
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowComplex_BGBlue.png", effects.addDropShadowComplex(IMAGE, 5, 50, [50, 50], "#0000ff", "#000000"))
...
def test_addDropShadowComplex_BGGreen():
	...
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowComplex_BGGreen.png", effects.addDropShadowComplex(IMAGE, 5, 50, [50, 50], "#00ff00", "#000000"))
...
def test_addDropShadowComplex_ShadowBlue():
	...
	bottom right on a red background
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowComplex_ShadowBlue.png", effects.addDropShadowComplex(IMAGE, 5, 50, [50, 50], "#ff0000", "#0000ff"))
...
def test_addDropShadowComplex_ShadowGreen():
	...
	bottom right on a red background
	'''
	io.saveImage(OUTPUT+ "/test_addDropShadowComplex_ShadowGreen.png", effects.addDropShadowComplex(IMAGE, 5, 50, [50, 50], "#ff0000", "#00ff00"))
...
def test_roundCornersAntiAlias():
	io.saveImage(OUTPUT+ "/test_roundCornersAntiAlias.png", effects.roundCornersAntiAlias(IMAGE, 256))
...
def test_roundCornersPercentAntiAlias():
	io.saveImage(OUTPUT+ "/test_roundCornersPercentAntiAlias.png", effects.roundCornersAntiAlias(IMAGE, "50%"))

def test_convertBlackAndWhite_background():
	io.saveImage(OUTPUT+ "/test_convertBlackAndWhite_background.png", effects.convertBlackAndWhite(IMAGE, "background"))

def test_convertBlackAndWhite_foreground():
	io.saveImage(OUTPUT+ "/test_convertBlackAndWhite_foreground.png", effects.convertBlackAndWhite(IMAGE, "foreground"))

def test_convertBlackAndWhite_filterLighter():
	io.saveImage(OUTPUT+ "/test_convertBlackAndWhite_filter-lighter.png", effects.convertBlackAndWhite(IMAGE, "filter-lighter"))

def test_convertBlackAndWhite_filterDarker():
	io.saveImage(OUTPUT+ "/test_convertBlackAndWhite_filter-darker.png", effects.convertBlackAndWhite(IMAGE, "filter-darker"))

def test_convertBlackAndWhite_edges():
	io.saveImage(OUTPUT+ "/test_convertBlackAndWhite_edges.png", effects.convertBlackAndWhite(IMAGE, "edges"))
